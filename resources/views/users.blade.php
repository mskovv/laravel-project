                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <a href="mailto:{{$user->find($user->user_id)->user->email}}" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> {{$user->find($user->user_id)->user->email}}</a>
