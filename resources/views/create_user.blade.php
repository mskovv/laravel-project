                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="username" value="{{old('username')}}">
                                </div>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control-file" name="avatar" value="{{old('avatar')}}">
                                </div>
                            </div>
                        </div>
